...
| 7 | `phase_7_retrieval_answer_evaluation.md` | `approved` | Baseline đã được xác nhận; post-simplicity correction hẹp đã duyệt scope và chờ triển khai/xác minh lại |
...
-> triển khai và xác minh lại Phase 7 theo exact approved scope
