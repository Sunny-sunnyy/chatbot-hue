...
| 7 | `phase_7_retrieval_answer_evaluation.md` | `ready` | Implement thiết kế evaluation đơn giản |
| 8 | `phase_8_benchmark_model_selection.md` | `not_ready` | Chờ Phase 7 và review Phase 0–6 |
